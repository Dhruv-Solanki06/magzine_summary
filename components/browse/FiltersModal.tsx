...
export const FiltersModal: React.FC<FiltersModalProps> = ({
  ...
  const [localFilters, setLocalFilters] = useState<FilterState>(mergeFilters(DEFAULT_FILTERS, initialFilters));
          ...
          <div className="flex items-center justify-between border-b border-slate-200 px-6 py-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Filter and sort summaries to find the perfect match.</p>
              </div>
            </div>
            <button
              type="button"
